  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6 items-center">
      ...
      <div className="flex flex-col gap-2 sm:gap-3">
        <h1 className="text-center font-semibold font-general-sans text-xl sm:text-2xl tracking-[-1%] text-[#0A090B]">
          {formDescription.title}
        </h1>
        <h3 className="text-center font-inter tracking-[-0.18px] text-sm sm:text-base text-[#696969]">
